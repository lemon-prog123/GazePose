...
argparser.add_argument('--filter_path',type=str, default='train_filter_all.json', help='Quality Filter')
...
argparser.add_argument('--mesh', action='store_true', help='mesh')
...
argparser.add_argument('--dsplit', type=float, default=0.1, help='Netsplit for xy coordinates')
argparser.add_argument('--csplit', type=float, default=0.1, help='Netsplit for confidence score')
