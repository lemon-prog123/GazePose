...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,mesh=False):
        self.inplanes = 64
    ...
    def forward(self, x,prior:torch.Tensor=None,pos:torch.Tensor=None,query_pos:torch.Tensor=None):
